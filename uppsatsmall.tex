...
utföra en morfologisk analys av texten och kan därmed tolka varje enskilt ords
...
stavfel minskar korrektheten och rättssäkerheten i rapporterna som lämnas in med
applikationen.
...
En polisrapport ska uppdelad i olika fördefinierade rubriker \citep{durtva:2017}. 
Om en rubrik som inte finns med i listan på de fördefinerade rubrikerna hittas skapas ett felmeddelande som 
beskriver felet och ett rättningsförslag på en rubrik som kan användas istället.
Rättningsförslaget är tas fram genom jämföra Levenshteinavståndet mellan den 
felaktiga rubriken med var och en av de fördefinerade rubrikerna. Den fördefinerade rubrik som har kortast avstånd
till den felaktiga rubriken blir rättningsförslaget.
...
\item \textbf{Ordvariationsindex (OVIX)}: Mäter hur många unika ord som finns i
  ...
  ändå få ett väldigt högt OVIX värde medans en längre svårläst text på 20 000
