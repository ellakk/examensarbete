...
\subsection{Användartester v2}\label{anvandartester2}

För att undersöka ifall förändringarna som genomfördes som resultat av det första användartestet (\cref{resultatanvändartester})
överlag lett till en förbättring av användargränssnittet har vi gjort samma test en gång till på samma
studenter.  Till skillnad mot det första användartestet har vi inte gjort några förändringar
i applikationen baserat på detta användartest utan vi lämnar det till eventuella framtida utvecklare.


\subsubsection{SUS}

$$(\sum_{n = 0}^{i = 0}\frac{n}{i}) * x * y$$

\subsubsection{Intervju}

Lorem

\subsubsection{Önskad funktionalitet}
